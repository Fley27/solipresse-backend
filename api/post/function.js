exports.isMatchContent = async (Post, status, category, tag, search,  nPerPage, pageNumber, isAvailable) => {
...
exports.isMatchPerDescription = async (Post, status, category, tag, search,  nPerPage, pageNumber, isAvailable) => {
    const posts = await Post.aggregate([
        {
            $match: {
                $and: [{category: {$in : category}}, {tags: {$in : tag}}],
...
exports.isMatchPerTitle = async (Post, status, category, tag, search,  nPerPage, pageNumber, isAvailable) => {
    const posts = await Post.aggregate([
        {
            $match: {
                $and: [{category: {$in : category}}, {tags: {$in : tag}}],
